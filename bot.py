...
class VolumeSelect(discord.ui.Select):
    def __init__(self):
        options = [
            ...
            discord.SelectOption(label="音量: 50% (預設)", value="0.5", emoji="🔉"),
            discord.SelectOption(label="音量: 80%", value="0.8", emoji="🔊"),
            discord.SelectOption(label="音量: 100% (最大)", value="1.0", emoji="📢")
        ]
